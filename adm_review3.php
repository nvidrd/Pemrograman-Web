...
if (isset($_GET['search'])) {
   ...
   $query  = mysqli_query($koneksi, "SELECT * FROM reviews3 where
   name              LIKE '%$keyword%' OR
   content           LIKE '%$keyword%' OR
   rating            LIKE '%$keyword%' OR
   submit_date       LIKE '%$keyword%'
   ");
} else {
   $query = mysqli_query($koneksi, "SELECT * FROM reviews3");
}
...
// HITUNG REVIEW MOIST 
$query2 = "SELECT id FROM reviews ORDER BY id";
...
// HITUNG REVIEW EYE LIP CARE
$query3 = "SELECT id FROM reviews2 ORDER BY id";
...
// HITUNG REVIEW CLEANSER TONER
$query4 = "SELECT id FROM reviews3 ORDER BY id";
$query4_run = mysqli_query($koneksi, $query4);

$row4 = mysqli_num_rows($query4_run);

function query4($data4)
{
   global $koneksi;
               ...
               <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="./adm_review1.php">
                        <i class="bi bi-bookmarks"></i> Reviews Moist
                     </a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="./adm_review2.php">
                        <i class="bi bi-bookmarks"></i> Reviews Eye & Lip
                     </a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="./adm_review3.php">
                        <i class="bi bi-bookmarks"></i> Reviews Cleanser
                     </a>
                  </li>
                  <li class="nav-item">
               ...
               <div class="mb-npx">
                  <div class="row align-items-center">
                     <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                        <!-- Title -->
                        <h1 class="h2 mb-0 ls-tight">Reviews Moisturizer</h1>
                     </div>
                     <!-- Actions -->
            ...
            <div class="container-fluid">
                  ...
                  <div class="col-xl-3 col-sm-6 col-12">
                     <div class="card shadow border-0">
                        <div class="card-body">
                           <div class="row">
                              <div class="col">
                                 <span class="h6 font-semibold text-muted text-sm d-block mb-2">Reviews Moisturizer</span>
                           ...
                           <div class="mt-2 mb-0 text-sm">
                              ...
                              <span class="text-nowrap text-xs text-muted">Since yesterday</span>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-xl-3 col-sm-6 col-12">
                     <div class="card shadow border-0">
                        <div class="card-body">
                           <div class="row">
                              <div class="col">
                                 <span class="h6 font-semibold text-muted text-sm d-block mb-2">Reviews Eye & Lip Care</span>
                  ...
                  <div class="col-xl-3 col-sm-6 col-12">
                     <div class="card shadow border-0">
                        <div class="card-body">
                           <div class="row">
                              <div class="col">
                                 <span class="h6 font-semibold text-muted text-sm d-block mb-2">Reviews Cleanser & Toner</span>
                                 <span class="h3 font-bold mb-0"><?php echo $row4; ?></span>
                              </div>
                              <div class="col-auto">
                                 <div class="icon icon-shape bg-tertiary text-white text-lg rounded-circle">
                                    <i class="bi bi-credit-card"></i>
               ...
               <div class="card shadow border-0 mb-7">
                        ...
                        <tbody>
                           ...
                           <?php foreach ($query as $data) : ?>
                              <tr style="text-align: center;">
                                 ...
                                 <td style="text-align: justify;"><?php echo $data['content']; ?></td>
                                 <td><?php echo $data['rating']; ?></td>
                                 <td><?php echo $data['submit_date']; ?></td>

                                 <!-- icon -->
                                 <td>
                                    <a href="./del_review1.php?id=<?php echo $data["id"]; ?>">
                  ...
                  <div class="card-footer border-0 py-5">
                     <span class="text-muted text-sm">Showing <?php echo $row4; ?> items out of 250 results found</span>
                  </div>
               </div>
            </div>
         </main>
