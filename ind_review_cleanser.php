...
<body>
    ...
    <div class="content home">
        <h2>Review Cleanser & Toner</h2>
        <p>Check out the below reviews for our cleanser & toner product.</p>

        <div class="reviews"></div>
        <script>
            const reviews_page_id = 1;
            fetch("reviews_cleanser.php?page_id=" + reviews_page_id).then(response => response.text()).then(data => {
                ...
                document.querySelector(".reviews .write_review form").onsubmit = event => {
                    event.preventDefault();
                    fetch("reviews_cleanser.php?page_id=" + reviews_page_id, {
                        method: 'POST',
