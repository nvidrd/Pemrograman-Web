                        ...
                        <div class="mx-n1">
                           <form action="" method="get">
                              <a href="#" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1">
                                 <span class=" pe-2">
                                    <input type="text" name="keyword" id="keyword" placeholder="Cari nama produk" autocomplete="off">
            ...
            <div class="container-fluid">
               ...
               <div class="card shadow border-0 mb-7">
                  <div class="card-header">
                     ...
                     <div class="row align-items-center">
                        <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                           <h5 class="mb-0">Database Produk</h5>
                        </div>
                        <!-- Actions -->
                        <div class="col-sm-6 col-12 text-sm-end">
                           <div class="mx-n1">
                     ...
                     <table class="table table-hover table-nowrap">
                        ...
                        <tbody>
                           ...
                           <?php foreach ($query as $data) : ?>
                              <tr style="text-align: center;">
                                 <td><?php echo $i; ?>.</td>
                                 <td><img src="img/<?= $data['gambar'] ?>" alt="" class="avatar avatar-sm rounded-circle me-2"></td>
                                 <td>
                                 ...
                                 <td>
                                    <span class="badge badge-lg badge-dot">
                                       <i class="bg-success"></i>Rp. <?php echo $data['harga_beli']; ?>
                                    </span>
                                 </td>
                                 <td>
                                    <span class="badge badge-lg badge-dot">
                                       <i class="bg-warning"></i>Rp. <?php echo $data['harga_jual']; ?>
                                    </span>
                                 </td>

                                 <!-- icon -->
                                 <td>
                                    <a href="./adm_update.php?id=<?php echo $data["id"]; ?>" class="btn d-inline-flex btn-sm btn-neutral border-base mx-1">
                                       <span class=" pe-2">
                                          <i class="bi bi-pencil"></i>
                                       </span>
                                       <span>Edit</span>
                                    </a>
                                    <a href="./adm_delete.php?id=<?php echo $data["id"]; ?>">
