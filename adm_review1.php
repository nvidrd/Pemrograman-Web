...
if (isset($_GET['search'])) {
   ...
   $query  = mysqli_query($koneksi, "SELECT * FROM reviews where
   ...
   $query = mysqli_query($koneksi, "SELECT * FROM reviews");
}
            ...
            <div class="container-fluid">
               ...
               <div class="card shadow border-0 mb-7">
                  ...
                  <div class="card-footer border-0 py-5">
                     <span class="text-muted text-sm">Showing <?php echo $row2; ?> items out of 250 results found</span>
                  </div>
               </div>
            </div>
         </main>
