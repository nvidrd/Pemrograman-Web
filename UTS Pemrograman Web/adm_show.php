                        ...
                        <tbody>
                           ...
                           <tr>
                              <td>
                                 <img alt="..." src="https://cdn.shopify.com/s/files/1/0203/8454/products/Herbivore_Bakuchiol_Retinol_Alternative_Smoothing_Serum.jpg?v=1570374211" class="avatar avatar-sm rounded-circle me-2">
                                 <a class="text-heading font-semibold" href="#">
                                    <?php echo $_POST['nama_barang']; ?>
                                 </a>
                              </td>
                              <td>
                                 <?php echo $_POST['kode_barcode']; ?>
                              </td>
                              <td>
                                 <a class="text-heading font-semibold" href="#">
                              ...
                              <td>
                              <?php echo $_POST['expired']; ?>
                              </td>
                              <td>
                                 <span class="badge badge-lg badge-dot">
                                    <i class="bg-success"></i>Rp. <?php echo $_POST['harga_beli']; ?>
                                 </span>
                              </td>
                              <td>
                                 <span class="badge badge-lg badge-dot">
                                    <i class="bg-warning"></i>Rp. <?php echo $_POST['harga_jual']; ?>
                                 </span>
                              </td>
                              <td class="text-end">
                                 <a href="#" class="btn btn-sm btn-neutral">View</a>
